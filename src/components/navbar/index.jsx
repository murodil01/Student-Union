...
const Navbar = () => {
  ...
  // Scroll listener (shadow va logo uchun)
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0) {
        setHasShadow(true);
  ...
  return (
    <>
      ...
      >
        <div
          className={`max-w-[1220px] mx-auto px-4 py-[20px] transition-all duration-300 ${
            isScrolled
              ? "flex flex-row items-center justify-between gap-6 relative"
              : "flex md:flex-row items-center justify-between gap-6 relative"
          }`}
        >
          ...
          >
            ...
            <div
              className={`flex items-center gap-[20px] ${
                isScrolled ? "justify-start" : "justify-end w-full"
              }`}
            >
              {/* Phone */}
              <a
