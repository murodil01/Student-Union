  ...
  return (
    ...
    >
      <div className="max-w-[1220px] mx-auto py-[250px] px-4 text-center flex flex-col justify-center items-center gap-[24px]">
        <h3 className="text-3xl md:text-[60px] font-[700] text-[#323232]">
        ...
        <div className="flex items-center gap-[20px]">
          <button className="w-full sm:w-[180px] text-[16px] font-medium text-[#323232] px-8 py-3 rounded-[24px] bg-[#FFB21A] shadow-[0px_4px_8px_0px_#FCB62980] transition hover:scale-105">
            Bog’laning
          </button>
