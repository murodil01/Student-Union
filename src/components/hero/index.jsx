...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* 👇 HTML darajasida LCP image discoverable bo‘lishi uchun */}
      <link rel="preload" as="image" href={hero_bg} fetchPriority="high" />

      <div className="max-w-[1220px] mt-[50px] md:mt-[90px] mx-auto pt-[50px] sm:pt-[50px] md:pt-[100px] lg:pt-[100px] pb-[40px] px-4 text-center flex flex-col justify-center items-center gap-[30px]">
        <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-snug">
          {text.map((wordText, index) => (
            <motion.span
              key={index}
