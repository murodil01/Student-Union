  ...
  return (
    <div className="max-w-[1220px] px-4 mx-auto text-center pt-[80px] md:pb-[80px] pb-0">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:mt-0 mt-10 gap-6 md:gap-0">
        ...
        <div className="relative z-30 w-[90%] sm:w-[80%] md:w-[480px] lg:w-[520px]">
          <img
            src={format1}
            alt="format1"
        ...
        <div className="relative md:mt-10 z-20 md:-ml-[20%] w-[90%] sm:w-[80%] md:w-[480px] lg:w-[520px]">
          <img
            src={format2}
            alt="format2"
            className="w-full rounded-xl shadow-2xl"
        ...
        <div className="relative md:mt-30 mt-0 z-10 md:-ml-[20%] w-[90%] sm:w-[80%] md:w-[480px] lg:w-[520px]">
          <img
            src={format3}
            alt="format3"
            className="w-full rounded-xl shadow-2xl"
