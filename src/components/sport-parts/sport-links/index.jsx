...
const SportLinks = () => {
  ...
  return (
    <div className="px-4">
      <div className="cyber-qualification bg-[rgb(246,246,246)] max-w-[1220px] mt-[200px] mb-[50px] mx-auto flex gap-5 flex-col md:flex-row items-center justify-between rounded-2xl px-6 md:px-10 pt-10 overflow-hidden">
