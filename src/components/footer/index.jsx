...
const Footer = () => {
  return (
    <>
      <div className="max-w-[1220px] mx-auto px-4 py-[80px] flex flex-col lg:flex-row gap-10 lg:gap-0 items-start justify-between">
        ...
        <div className="flex flex-col gap-4">
          <img
            ...
            alt="Logo"
          />
          <a className="text-[16px] text-[#323232]" href="#">
            info@su-tuit.uz
          </a>
          <a className="text-[14px] text-[#323232]" href="#">
        ...
        <div className="flex flex-col md:flex-row md:flex-nowrap gap-8 md:gap-[40px] lg:gap-[70px] w-full">
          ...
          <div className="flex flex-col gap-2 text-left flex-1 min-w-[150px]">
            <h3 className="text-[#323232] text-[18px] font-[700]">Home</h3>
            <a className="text-[#323232] text-[16px]" href="#">
              Biz haqimizda
            </a>
            <a className="text-[#323232] text-[16px]" href="#">
              Bizning klublarimiz
          ...
          {/* About Links */}
          <div className="flex flex-col gap-2 text-left flex-1 min-w-[150px]">
            <h3 className="text-[#323232] text-[18px] font-[700]">
              Biz haqimizda
            </h3>
            <a className="text-[#323232] text-[16px]" href="#">
              A’zo bo’lish
      ...
      {/* Bottom */}
      <div className="bg-[#916802] py-[14px]">
