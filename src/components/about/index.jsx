...
const About = () => {
  return (
    <div className="max-w-[1220px] mx-auto px-4 py-[80px] flex flex-col items-center gap-[16px]">
      <h2 className="text-3xl md:text-[60px] font-[700] text-[#323232] text-center">
        Biz haqimizda
      </h2>
      <p className="text-base md:text-[20px] font-normal text-[#323232] max-w-[540px] text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] items-center w-full">
        ...
        <div className="flex flex-col gap-[20px] text-left">
          <h3 className="text-[#323232] text-[24px] font-[400]">
          ...
          <ul className="flex flex-col gap-[24px]">
            <li className="flex items-center gap-[20px] text-[#323232] text-[16px] font-[400]">
          ...
          <h3 className="text-[#323232] text-[16px] font-[400]">
            Toshkent Axborot Texnologiyalari Universiteti Talabalar Ittifoqi —
