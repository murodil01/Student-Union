    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] items-center w-full mt-10">
        ...
        <div className="flex flex-col gap-[20px] text-left order-first md:order-last">
          ...
          <button className="text-[16px] flex items-center gap-5 font-medium max-w-[255px] w-full px-8 py-3 rounded-[24px] bg-[#FFB21A] shadow-[0px_4px_8px_0px_#FCB62980] transition hover:scale-105">
